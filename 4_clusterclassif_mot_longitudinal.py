...
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/class1.csv', index=False)
df = pd.DataFrame(class2)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/class2.csv', index=False)
df = pd.DataFrame(class3)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/class3.csv', index=False)
df = pd.DataFrame(class4)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/class4.csv', index=False)
...
from sklearn.inspection import permutation_importance
import sklearn.cluster
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/class1.csv', header=None, skiprows=1)
class1 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/class2.csv', header=None, skiprows=1)
class2 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/class3.csv', header=None, skiprows=1)
class3 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/class4.csv', header=None, skiprows=1)
class4 = df.to_numpy()
...
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/cent1.csv', index=False)
df = pd.DataFrame(cent2)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/cent2.csv', index=False)
df = pd.DataFrame(cent3)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/cent3.csv', index=False)
df = pd.DataFrame(cent4)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/cent4.csv', index=False)

df = pd.DataFrame(features)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/features.csv', index=False)
df = pd.DataFrame(labels)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/labels.csv', index=False)

#%%
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/cent1.csv', header=None, skiprows=1)
cent1 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/cent2.csv', header=None, skiprows=1)
cent2 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/cent3.csv', header=None, skiprows=1)
cent3 = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/cent4.csv', header=None, skiprows=1)
cent4 = df.to_numpy()

df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/features.csv', header=None, skiprows=1)
features = df.to_numpy()
df = pd.read_csv('C:/Users/cpose/Desktop/main/results/transv/labels.csv', header=None, skiprows=1)
labels = df.to_numpy()

clf = joblib.load('C:/Users/cpose/Desktop/main/results/transv/Classifier')
#%% TRAIN
print("\nStart training...")
...
# Saving:
joblib.dump(clf, 'C:/Users/cpose/Desktop/main/results/transv/Classifier')
...
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/predict.csv', index=False)
df = pd.DataFrame(fulllabels)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/fulllabels.csv', index=False)
...
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/perm_imp_values.csv', index=False)
df = pd.DataFrame(perm_imp_names)
df.to_csv('C:/Users/cpose/Desktop/main/results/transv/perm_imp_names.csv', index=False)